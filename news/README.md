...
- April 10 - April 27. Xiaohui finished a long Beijing-Guilin-Chengdu-Qingdao-Chongqing-Beijing trip, giving talks on possible alpha_s extraction in the unexpected post-confinement regime of EEC.
    ...
    <img src="./guilin.jpg" width="375" height="177">
...
<img src="./workflow-ai.png" width="475" height="500">
  ...
  The protocols are designed for AI coding agents, while a test was conducted using ChatGPT-5.4-thinking, operating through a webpage, and relying on its sandbox service. Before writing, the AI is required to do in-depth reference research based on the user's writing  motivation. At the beginning (forced) and end (strongly suggested) of each stage, the files generated are audited to meet the protocol requirements. The conversation used to write a regular research paper can be found [here](https://l-x-x.github.io/news/regular-article-ai.pdf), and for a review paper, see [here](https://l-x-x.github.io/news/review-article-ai.pdf). Compared with writing (stage 3 and stage 4), It is more interesting to observe the learning process: how the LLM becomes aware of potential mistakes in the provided (unchecked) equations and references and how, by reading the references in Stage 2, it builds a clear picture of the research—including its history, connections between different papers, and trends. Here is an exemplary [review article](https://l-x-x.github.io/news/energy_correlators_polished.pdf) on the Energy Correlator using this procedure with minimal human input, and ZERO touch of the draft. Here is another example for the protocols used for [proposal-writing](https://l-x-x.github.io/news/proposal-writing.pdf) (**FOR TEST ONLY**) and a layer for [polishing and final draft](https://l-x-x.github.io/news/polishing.pdf). 
